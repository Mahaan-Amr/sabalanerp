...
**بازه سنجش عملکرد**:
فاصله صریح «از تاریخ» تا «تا تاریخ» در یک ارزیابی عملکرد پرسنل است که تعیین می‌کند مقادیر واقعی شاخص‌ها متعلق به چه زمانی‌اند. این بازه فقط درون یک Employment Relationship قرار می‌گیرد و از زمان ثبت، نهایی‌سازی و اعتبار سطح جاری مستقل است.
