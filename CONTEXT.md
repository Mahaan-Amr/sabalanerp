...
مجموعه نسخه‌دار شاخص‌های وزن‌دار، هدف‌ها، واحدها و جهت مطلوب برای یک بخش کاری است. معیارها و وزن‌های مصوب Excel برای هر بخش یک فرم می‌سازند و سامانه فرم فعالِ منطبق با واحد سازمانی جاری Personnel را خودکار انتخاب می‌کند؛ ارزیاب در مسیر روزمره فرم انتخاب یا تخصیص نمی‌دهد. `آماده‌سازی فرم` معیارهای همان بخش را برای بررسی نشان می‌دهد. هر تغییر آینده نسخه تازه می‌سازد و فقط ارزیابی‌هایی که پس از فعال‌شدن آن آغاز می‌شوند از نسخه تازه استفاده می‌کنند؛ نتیجه‌های قبلی و پیش‌نویس‌های موجود نسخه خود را حفظ می‌کنند.
_Avoid_: ورود دوباره معیارهای Excel هنگام آماده‌سازی، یکی‌گرفتن الگو با واحد سازمانی یا Job، انتخاب الگو به‌دست ارزیاب، نیاز به تخصیص دستی الگوی اصلی برای هر Personnel، انتخاب چند الگوی فعال هم‌زمان، تغییر ارزیابی باز یا نتیجه قبلی با نسخه تازه، یا معیار شخصی بدون الگوی نسخه‌دار
