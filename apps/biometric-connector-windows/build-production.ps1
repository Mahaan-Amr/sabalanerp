...
$output = Join-Path $artifactDirectory 'Sabalan.BioMini.Adapter.exe'
& $compiler /nologo /target:exe /platform:x64 /optimize+ /define:SABALAN_PRODUCTION ("/out:$output") $references $sources
