-- Finalizing a Partner technical recovery is the one legitimate transition
-- from an open Partner-owned edit session to its exact Partner customer
-- contract. Keep every other incompatible persona assignment fail-closed.
