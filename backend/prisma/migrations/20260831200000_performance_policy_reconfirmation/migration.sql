DROP INDEX IF EXISTS "performance_policy_activation_previews_policy_key";

CREATE INDEX "performance_policy_activation_previews_policyVersionId_generatedAt_idx"
  ON "performance_policy_activation_previews"("policyVersionId", "generatedAt");
...
BEGIN
  ...
  is_policy_reconfirmation := TG_TABLE_NAME = 'performance_policy_versions'
    AND old_state = 'SCHEDULED'
