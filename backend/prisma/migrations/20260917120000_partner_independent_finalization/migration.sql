...
-- Customer confirmation is an independent axis. A priced current revision may
-- become commercially binding while the customer is silent; an explicit
-- rejection is enforced by the transactional lifecycle writer.
