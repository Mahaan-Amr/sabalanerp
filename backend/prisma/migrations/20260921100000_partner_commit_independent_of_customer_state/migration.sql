-- Explicit Partner finalization is independent of whether a customer response
-- was sent before the cutover. New flows send only after COMMITTED; retained
-- pre-cutover pending/approved Cases may still finalize without regression.
