...
export const FEATURE_LABELS: Record<Feature, string> = {
  ...
  [FEATURES.CRM_CUSTOMERS_ASSIGN_OWNER]: 'CRM Customers - Assign Owner',
  ...
  [FEATURES.CRM_POTENTIAL_PROJECTS_VIEW]: 'CRM Potential Projects - View',
  [FEATURES.CRM_POTENTIAL_PROJECTS_CREATE]: 'CRM Potential Projects - Create',
  [FEATURES.CRM_POTENTIAL_PROJECTS_EDIT]: 'CRM Potential Projects - Edit',
  [FEATURES.CRM_POTENTIAL_PROJECTS_REASSIGN]: 'CRM Potential Projects - Reassign',
  [FEATURES.CRM_FOLLOW_UPS_VIEW]: 'CRM Follow-ups - View',
  [FEATURES.CRM_FOLLOW_UPS_CREATE]: 'CRM Follow-ups - Create',
  [FEATURES.CRM_NEXT_ACTIONS_VIEW]: 'CRM Next Actions - View',
  [FEATURES.CRM_NEXT_ACTIONS_EDIT]: 'CRM Next Actions - Edit',
  ...
  [FEATURES.SALES_CUSTOMERS_ASSIGN_OWNER]: 'Sales Customers - Assign Owner',
  ...
  [FEATURES.HR_DASHBOARD_VIEW]: 'مشاهده داشبورد منابع انسانی',
  [FEATURES.HR_ORGANIZATION_VIEW]: 'مشاهده ساختار سازمانی',
  [FEATURES.HR_ORGANIZATION_CREATE]: 'ایجاد واحد، شغل و جایگاه',
  [FEATURES.HR_ORGANIZATION_EDIT]: 'ویرایش واحد، شغل و جایگاه',
  [FEATURES.HR_ORGANIZATION_ARCHIVE]: 'بایگانی تعاریف سازمانی',
  [FEATURES.HR_ORGANIZATION_DELETE]: 'حذف دائمی تعاریف سازمانی',
  [FEATURES.HR_PERSONNEL_VIEW]: 'مشاهده پرسنل',
  [FEATURES.HR_PERSONNEL_EDIT]: 'ویرایش پرسنل',
  [FEATURES.HR_RECRUITMENT_VIEW]: 'مشاهده پرونده‌های جذب',
  [FEATURES.HR_RECRUITMENT_EDIT]: 'ویرایش پرونده‌های جذب',
  [FEATURES.HR_ASSESSMENTS_EDIT]: 'ثبت مصاحبه و ارزیابی استخدام',
  [FEATURES.HR_WORK_MANAGEMENT_VIEW]: 'مشاهده وظایف منابع انسانی',
  [FEATURES.HR_WORK_MANAGEMENT_EDIT]: 'مدیریت وظایف منابع انسانی',
  [FEATURES.HR_PERMISSIONS_VIEW]: 'مشاهده اختیار و مسئولیت',
  [FEATURES.HR_PERMISSIONS_EDIT]: 'مدیریت اختیار و مسئولیت',
  [FEATURES.HR_MIGRATION_VIEW]: 'مشاهده مهاجرت و تطبیق',
  [FEATURES.HR_MIGRATION_EDIT]: 'اجرای مهاجرت و تطبیق',
  [FEATURES.HR_USERS_VIEW]: 'مشاهده کاربران',
  [FEATURES.HR_USERS_CREATE]: 'ایجاد کاربران',
  [FEATURES.HR_USERS_EDIT]: 'ویرایش کاربران',
  [FEATURES.HR_USERS_DELETE]: 'حذف کاربران',
