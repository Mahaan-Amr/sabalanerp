...
assert.deepEqual(registeredRoutes, [
  ...
  'POST /simple/evaluations/:evaluationId/publish',
  'POST /simple/evaluations/:evaluationId/appeal',
  'POST /simple/evaluations/:evaluationId/resolve-appeal',
  ...
  'PUT /behavior-surveys/:campaignId/responses/:targetPersonnelId',
  'GET /behavior-surveys/:campaignId/aggregate',
  'GET /behavior-surveys/:campaignId/raw/:targetPersonnelId',
  'GET /rollout',
