...
const expectedAccountability = {
  ...
  HIRING_COLLATERAL_RECORD_RECEIPT: ['INDIVIDUAL_EXECUTION', false],
  HIRING_COLLATERAL_VERIFY_RECEIPT: ['SHARED_DECISION', false],
  HIRING_COLLATERAL_RECORD_ORIGINAL_RETURN: ['INDIVIDUAL_EXECUTION', false],
  HIRING_COLLATERAL_VERIFY_ORIGINAL_RETURN: ['SHARED_DECISION', false],
} as const;
