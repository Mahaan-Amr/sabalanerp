...
assert.deepEqual(PERFORMANCE_ACTION_PERMISSION_CODES, [
  ...
  'EVALUATE_DIRECT_REPORTS',
  'EVALUATE_ALL_PERSONNEL',
  'MANAGE_PERFORMANCE_PROFILES',
  'VIEW_PERFORMANCE_BADGE_LIST',
  'MANAGE_PERFORMANCE_SURVEYS',
  'RESPOND_PERFORMANCE_SURVEYS',
  'ENTER_PERFORMANCE_EVIDENCE',
  'FINALIZE_PERFORMANCE_RESULTS',
  'VIEW_RAW_PERFORMANCE_SURVEY',
]);
