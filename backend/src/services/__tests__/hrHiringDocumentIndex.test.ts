...
const application = {
  documents: [{ id: 'identity-1', category: 'NATIONAL_CARD', side: 'FRONT', version: 2, status: 'VERIFIED', originalName: 'id.pdf', uploadedBy: 'hr-1', createdAt: new Date('2026-07-20') }],
  assessments: [{ id: 'assessment-1', assessmentType: 'DISC', version: 1, status: 'ACTIVE', originalName: 'disc.pdf', recordedBy: 'hr-2', recordedAt: new Date('2026-07-21') }],
