...
export const HR_DUTY_DEFINITIONS = Object.freeze({
  ...
  FINANCE_RECORDING: dutyDefinition('FINANCE_RECORDING', 'FINANCE_RECORDER', 'ACCOUNTING', 'MANAGE_FINANCE_EVIDENCE', 'INDIVIDUAL_EXECUTION'),
  FINANCE_APPROVAL: dutyDefinition('FINANCE_APPROVAL', 'FINANCE_MANAGER', 'ACCOUNTING', 'MANAGE_FINANCE_EVIDENCE', 'SHARED_DECISION'),
