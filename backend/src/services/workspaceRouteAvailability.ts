...
const rules: Rule[] = [
  ...
  { pattern: /^\/dashboard\/sales\/partner-inquiries(?:\/|$)/, workspace: 'sales', features: [],
    partnerPurposes: ['PARTNER', 'RESPONDER'], partnerProfileStates: ['ACTIVE', 'SUSPENDED', 'TERMINATED'] },
  { pattern: /^\/dashboard\/sales\/partner-cases(?:\/|$)/, workspace: 'sales', features: [],
    partnerPurposes: ['PARTNER', 'MANAGEMENT', 'ACCOUNTING', 'FULFILLMENT'],
    partnerProfileStates: ['ACTIVE', 'SUSPENDED', 'TERMINATED'] },
  { pattern: /^\/dashboard\/sales\/partner-customers(?:\/|$)/, workspace: 'sales', features: [],
    partnerPurposes: ['PARTNER', 'MANAGEMENT', 'CRM'],
    partnerProfileStates: ['ACTIVE', 'SUSPENDED', 'TERMINATED'] },
  { pattern: /^\/dashboard\/sales\/partner-reports(?:\/|$)/, workspace: 'sales', features: [],
    partnerPurposes: ['PARTNER', 'MANAGEMENT', 'ACCOUNTING'],
    partnerProfileStates: ['ACTIVE', 'SUSPENDED', 'TERMINATED'] },
