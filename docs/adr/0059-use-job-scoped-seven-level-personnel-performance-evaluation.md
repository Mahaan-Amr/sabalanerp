...
Behavioral evidence combines Supervisor judgment, unlimited confidential peer-survey campaigns, and valid attendance data. Repeated surveys do not multiply one respondent's influence: responses are first aggregated per respondent, target, factor, and period, then combined equally across distinct respondents; raw comments never score, identities remain hidden from the target and ordinary viewers, and the special alternate-resolution workflow for an HR Manager or Company Manager who is themselves the target is deliberately deferred.

Results become official only after source validation, calculation, Personnel disclosure, a seven-day appeal opportunity, and finalization. A result may be documented evidence in a separate human decision about compensation, promotion, improvement, or discipline, but never executes such a consequence automatically; source corrections create traceable recalculation or linked result versions and require dependent decisions to be reviewed. This decision supersedes ADR-0057 for new performance evaluations while retaining former results as immutable historical evidence.
