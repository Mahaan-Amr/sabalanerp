...
The additive 1.4.0 package introduces validated technical save and historical
saved-reference read contracts. The generic foundation check remains a wire-v1
compatibility check; it does not certify the real inquiry-evidence producer,
authorization integration, committed concurrency, 330 UI, or 334/335 acceptance.
See `docs/implementation/partner-sales/technical-validated-save.md` for module
verification and its explicit adapter boundaries. Historical evidence is unchanged.

The additive 1.5.0 package adds a purpose-bound, versioned Sales-management
technical pricing policy. It preserves wire schemaVersion 1. Private rates remain
absent from Partner catalog, recovery, saved-reference and Case views; this
harness pin does not claim live policy administration or activation acceptance.
...
The additive 1.9.0 package preserves schemaVersion 1 and adds the strict,
...
The additive 1.10.0 package preserves all schemaVersion 1 contracts and adds the
separate activation schemaVersion 3 package. Its acceptance evidence belongs to
the current activation candidate and does not relabel the frozen 1.9.0 reports.
