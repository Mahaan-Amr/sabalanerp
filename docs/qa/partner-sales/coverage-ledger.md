...
| S-01 | Unauthenticated user | Sales create deep-link → login; RTL, keyboard, no horizontal overflow; desktop/narrow × light/dark | #314 QA | blocked | Browser test exists; latest execution/visual result must be recorded in baseline |
