...
- قرارداد خواندن سازگار برای حراست، User management و Personal Affairs تعریف شود.
...
- حراست فقط برنامه قابل‌اعمال را بخواند و Snapshot حضور نهایی را نگه دارد.
...
**دروازه پذیرش:** داده خام حراست هرگز به‌تنهایی حق پرداخت یا کسر ایجاد نکند.
