...
| `/api/hr/personnel/:id/work-schedule` | وجود نداشت | ثبت نسخه جدید برنامه کاری با مجوز edit در HR | مرجع برنامه کاری تا تکمیل مدل Assignment/Schedule در ۲.۱.۴ |
...
- تغییر برنامه کاری فقط از صفحه HR و endpoint دارای مجوز HR انجام می‌شود.
- قبل از حذف GET قدیمی، User management باید به endpoint محدود و permission-safe منتقل شود.
- قبل از تغییر resolver حراست، اختلاف برنامه جاری و برنامه هدف برای داده واقعی گزارش و رفع شود.
