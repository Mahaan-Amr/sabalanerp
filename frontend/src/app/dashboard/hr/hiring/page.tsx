...
export default function HiringCasesPage() {
  ...
  return <ErpPage eyebrow="منابع انسانی · استخدام" title="پرونده‌های استخدام" description="جریان یکپارچه متقاضی، بررسی HR، امور مالی، تبدیل به پرسنل و فعال‌سازی" backHref="/dashboard/hr" actions={[{ label: 'اختیارها', icon: FaCog, href: '/dashboard/hr/hiring/authorities' }, { label: 'به‌روزرسانی', icon: FaSync, onClick: load }]}>
