...
export default function RegisterPage() {
  ...
  const departments: Department[] = [
    ...
    { id: '4', name: 'Finance', namePersian: 'مالی و حسابداری' },
    { id: '5', name: 'Warehouse', namePersian: 'انبار' },
    { id: '6', name: 'Security', namePersian: 'حراست' },
    { id: '7', name: 'Procurement', namePersian: 'تدارکات' },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setErrors({ general: data.error || 'ثبت‌نام ناموفق بود' });
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">حساب جدید خود را ایجاد کنید</p>
        </div>
