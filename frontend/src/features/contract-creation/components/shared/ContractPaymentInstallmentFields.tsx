...
export function ContractPaymentInstallmentFields({ method, amount, date, amountLabel = 'مبلغ (تومان)',
  dateLabel = 'تاریخ پرداخت', disabledAmount = false, disabled = false, amountError, dateError,
  ...
  return <div className="grid gap-3 sm:grid-cols-3">
    <ErpField label="روش پرداخت"><ContractPaymentMethodSelect value={method} disabled={disabled}
