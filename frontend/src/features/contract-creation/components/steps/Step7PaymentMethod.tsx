    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          پرداخت‌های قرارداد را تعریف کنید (می‌توانید چندین پرداخت اضافه کنید)
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <span className="text-sm text-gray-600 dark:text-gray-400">مبلغ کل قرارداد:</span>
              <div className="mr-2">
            ...
            <div>
              <span className="text-sm text-gray-600 dark:text-gray-400">مجموع پرداخت‌ها:</span>
              <div className="mr-2">
            ...
            <div>
              <span className="text-sm text-gray-600 dark:text-gray-400">مبلغ باقیمانده:</span>
              <div className="mr-2">
          ...
          {!paymentSumMatchesTotal && (
            <div className="mt-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded">
              <p className="text-yellow-700 dark:text-yellow-300 text-sm">
                ⚠️ مجموع مبالغ پرداختی ({formatPrice(paymentSum, wizardData.payment.currency)}) با مبلغ کل قرارداد ({formatPrice(wizardData.payment.totalContractAmount, wizardData.payment.currency)}) برابر نیست
              </p>
            </div>
          )}
          ...
          {paymentSumMatchesTotal && paymentSum > 0 && (
            <div className="mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded">
              <p className="text-green-700 dark:text-green-300 text-sm flex items-center gap-2">
                ...
                مجموع پرداخت‌ها با مبلغ کل قرارداد برابر است
              </p>
            </div>
          )}
        </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
                          {payment.method === 'CASH' ? 'نقدی' : payment.method === 'CHECK' ? 'چک' : 'قسطی'}
                        </span>
                      </div>
        ...
        {errors.payments && (
          <p className="text-red-500 text-sm mt-2">{errors.payments}</p>
        )}
      </div>
    </div>
  );
