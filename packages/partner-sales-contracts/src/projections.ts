...
export const CustomerContractOutputSchema = z.object({
  ...
  products: z.array(ProductDisplaySchema.extend({ retailUnitPrice: DecimalSchema,
    ...
    areaSquareMeters: DecimalSchema.optional(), count: DecimalSchema.optional(),
    retailLineTotal: DecimalSchema.optional() }).strict()).min(1),
  project: z.object({ title: TextSchema, address: TextSchema.optional(), managerName: TextSchema.optional() }).strict().optional(),
