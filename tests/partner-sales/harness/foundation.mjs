...
export const foundationInterface = '@sabalanerp/partner-sales-contracts@1.10.0; schemaVersion=1; activationSchemaVersion=3';
...
export function loadFoundation() {
  ...
  if (contract.PARTNER_CONTRACT_VERSION !== '1.10.0' || contract.PARTNER_SCHEMA_VERSION !== 1) {
