...
export const foundationInterface = '@sabalanerp/partner-sales-contracts@1.3.0; schemaVersion=1';
...
export function loadFoundation() {
  ...
  if (contract.PARTNER_CONTRACT_VERSION !== '1.3.0' || contract.PARTNER_SCHEMA_VERSION !== 1) {
